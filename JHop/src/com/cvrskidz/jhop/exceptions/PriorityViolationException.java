...
/**
 * Exception warning two incompatible commands have been used in conjucntion with one another. 
 * 
...
public class PriorityViolationException extends CommandException{
    ...
    /**
     * Constructs a new PriorityViolationException specifiyng the valid command prevented by the invalid command.
     * 
     * @param valid The name of the valid command prevented from being executed.
     * @param invalid The name of the invlaid command supplied.
     */    
